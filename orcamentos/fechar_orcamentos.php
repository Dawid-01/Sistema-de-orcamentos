            ...
            <div class="modal-body">
              <form method="POST" action="">
               ...
               <div class="form-group">
                <label for="quantidade">Valor Brindes</label>
                <input type="text" class="form-control mr-2" name="txtvalor" placeholder="Valor Brindes" required>
              </div>

               <div class="form-group">
                <label for="quantidade">Valor Frete</label>
                <input type="text" class="form-control mr-2" name="txtpecas" placeholder="Frete" required>
              </div>


                <div class="form-group">
                <label for="quantidade">Valor Total</label>
                <input type="text" class="form-control mr-2" name="txtvalorPecas" placeholder="Valor Total" required>
              </div>

              <div class="form-group">
                <label for="quantidade">Resumo</label>
                <textarea class="form-control mr-2" name="txtlaudo" placeholder="Resumo" required> </textarea>
              </div>
